...
class YouTubeDownloader:
    ...
    def _prepare_download_options(self, format_id: str, task_id: str) -> dict:
        ...
        # ------------------ উন্নত সিকিউরিটি ও ক্লায়েন্ট ইমুলেশন ------------------
        ydl_opts.update({
            'extractor_args': {
                'youtube': {
                    'player_client': ['android', 'web'], # অ্যান্ড্রয়েড ক্লায়েন্ট ব্যবহার করলে ব্লক কম হয়
            ...
            # একটি রিয়েল ব্রাউজারের ইউজার এজেন্ট
            'user_agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36 Brave/1.62.153',
        })
        ...
        # ডকার কন্টেইনারের জন্য রুট পাথ চেক
        ...
        # ------------------ আপনার সফল লজিক (সামান্য উন্নত করা হয়েছে) ------------------
        if format_id == 'mp3':
            ...
            if format_id == 'best':
                # সর্বোচ্চ কোয়ালিটির জন্য
                ydl_opts['format'] = 'bestvideo[vcodec!=av01][ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best'
            else:
                # আপনার দেওয়া লজিকটি বজায় রাখা হয়েছে
                # শেষে '/best' যোগ করা হয়েছে যাতে স্পেসিফিক হাইট না পাওয়া গেলে ডাউনলোড ফেইল না করে
